...
<div class="container mx-auto py-8 max-w-2xl">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">
        {{ isset($lowongan) ? 'Edit Lowongan' : 'Buat Lowongan Baru' }}
    </h1>
    ...
    <form method="POST" action="{{ isset($lowongan) ? route('mitra.lowongans.update', $lowongan) : route('mitra.lowongans.store') }}">
        @csrf
        @if (isset($lowongan))
            @method('PUT')
        @endif
